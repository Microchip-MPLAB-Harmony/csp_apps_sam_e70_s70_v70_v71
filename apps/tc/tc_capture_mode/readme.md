...
# Timer Counter (TC) capture mode example  (tc_capture_mode)

This example demonstrates how to use the TC module in capture mode to measure duty cycle and frequency of an external input.
