...
# Supply Controller (SUPC) entering low power mode and exiting using RTT example (supc_wakeup_rtt)

This example demonstrates entering different low power modes and exiting it using the RTT alarm.
