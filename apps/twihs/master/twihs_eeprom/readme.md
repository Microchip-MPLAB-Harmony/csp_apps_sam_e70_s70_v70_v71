...
# Two Wire Interface (TWIHS) EEPROM read write example (twihs_eeprom)

This example application demonstrates how to use the TWIHS peripheral to write and read from the I2C serial EEPROM memory.
...
| Project Name| Board|
|:---------|:---------:|
|sam_e70_xult.X <br> sam_e70_xult_iar.IAR|[![sam_e70_xult](https://www.microchip.com/_ImagedCopy/180730-MCU32-PHOTO-DM320113-Angle-7x5.jpg)](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/DM320113)|
